// DukeDustyNebula4
// Modified from https://www.shadertoy.com/view/MsVXWW
// Original author: https://www.shadertoy.com/user/Duke
import { useRef } from 'react';
import { useShaderToy } from '../../utility';

export function DukeDustyNebula4() {
  const canvasRef = useRef<HTMLCanvasElement | null>(null);
  useShaderToy(fragment, canvasRef, { enableMouse: false, timeFactor: 0.0002 });
...
vec4 mainImage(vec2 fragCoord) {
  ...
  #endif
  #ifdef TONEMAPPING
  return vec4(ToneMapFilmicALU(sum.xyz*2.2), 1.0);
  #else
